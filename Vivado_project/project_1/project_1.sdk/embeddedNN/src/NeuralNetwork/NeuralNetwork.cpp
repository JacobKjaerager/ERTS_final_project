...
NeuralNetwork* NeuralNetwork::instance_ = nullptr;
XNeuralnetwork NeuralNetwork::nn = XNeuralnetwork();
XScuTimer NeuralNetwork::timerInstance = XScuTimer();
float NeuralNetwork::totalTime = 0;

u32 ONE_SECOND = 325000000; // half of the CPU clock speed

NeuralNetwork* NeuralNetwork::getInstance(){
	if (instance_ == nullptr) {
		instance_ = new NeuralNetwork();
	}
	return instance_;
}
