...
HD_PWD='C:/Users/jespe/Desktop/Uni_Civil_9_Semester/Embedded_course/ERTS_final_project/Vivado_project/project_1/project_1.runs/design_1_Button_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Button_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Button_1.tcl
