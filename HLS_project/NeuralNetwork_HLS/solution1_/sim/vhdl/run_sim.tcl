...
if {[file isfile NeuralNetwork.autotvin.dat]} {
	file delete -force NeuralNetwork.autotvin.dat
}

if {[file isfile NeuralNetwork.autotvout.dat]} {
	file delete -force NeuralNetwork.autotvout.dat
}
