...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.NeuralNetwork.autotvin_input_r.dat"
         "c.NeuralNetwork.autotvin_biasWeight_input_r.dat"
         "c.NeuralNetwork.autotvin_runNN_r.dat"
         "c.NeuralNetwork.autotvin_setBais_r.dat"
         "c.NeuralNetwork.autotvin_setWeight_r.dat"
         "c.NeuralNetwork.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.NeuralNetwork.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
