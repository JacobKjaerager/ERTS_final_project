...
$(ObjDir)/testbench_vivado.cpp_pre.cpp.tb.o : testbench_vivado.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling testbench_vivado.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/neuralnetwork_ccode.cpp_pre.cpp.tb.o : neuralnetwork_ccode.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling neuralnetwork_ccode.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
