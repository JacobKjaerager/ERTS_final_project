...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "NeuralNetwork.autotvin.dat"
	set constFileTvOut       "NeuralNetwork.autotvout.dat"
	set constFileHdlTvIn     "NeuralNetwork.autohdltvin.dat"
	set constFileHdlTvOut    "NeuralNetwork.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
