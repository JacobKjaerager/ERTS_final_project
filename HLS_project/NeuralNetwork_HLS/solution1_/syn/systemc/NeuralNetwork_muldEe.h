...
#ifndef __NeuralNetwork_muldEe__HH__
#define __NeuralNetwork_muldEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NeuralNetwork_muldEe) {
    ...
    SC_CTOR(NeuralNetwork_muldEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
