...
#ifndef __NeuralNetwork_macfYi__HH__
#define __NeuralNetwork_macfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NeuralNetwork_macfYi) {
    ...
    SC_CTOR(NeuralNetwork_macfYi):  simcore_mac_0_U ("simcore_mac_0_U") {
