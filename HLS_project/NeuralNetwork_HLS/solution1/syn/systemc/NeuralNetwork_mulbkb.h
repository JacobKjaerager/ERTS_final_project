...
#ifndef __NeuralNetwork_mulbkb__HH__
#define __NeuralNetwork_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NeuralNetwork_mulbkb) {
    ...
    SC_CTOR(NeuralNetwork_mulbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
