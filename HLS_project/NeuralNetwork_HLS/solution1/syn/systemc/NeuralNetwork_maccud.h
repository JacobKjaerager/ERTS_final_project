...
#ifndef __NeuralNetwork_maccud__HH__
#define __NeuralNetwork_maccud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(NeuralNetwork_maccud) {
    ...
    SC_CTOR(NeuralNetwork_maccud):  simcore_mac_0_U ("simcore_mac_0_U") {
