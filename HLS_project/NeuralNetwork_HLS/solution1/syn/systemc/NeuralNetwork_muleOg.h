...
#ifndef __NeuralNetwork_muleOg__HH__
#define __NeuralNetwork_muleOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(NeuralNetwork_muleOg) {
    ...
    SC_CTOR(NeuralNetwork_muleOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
